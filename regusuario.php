...
<h3>Nombre completo</h3><input type="text" name="nombre"></input><br><br>
<h3>Telefono</h3><input type="text" name="telefono"></input><br><br>
<h3>E-mail</h3><input type="text" name="email"></input><br><br>
<h3>Compania</h3><input type="text" name="compania"></input><br><br>
<h3>Direccion</h3><input type="text" name="direccion"></input><br><br>
<h3>RFC</h3><input type="text" name="rfc"></input><br><br>
