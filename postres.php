<?php 
    ...
    if (mysqli_connect_errno()) {
        ...
        $sql = 'SELECT Name, Price, Description, imgName FROM Dishes WHERE Category = 4';
		...
		//Segunda consulta
		$sql2 = 'SELECT Dato FROM didYouKnow WHERE ID = 4';
...
<body>
			...
			<div class="navigation">
			 <span class="menu"></span> 
				<ul class="navig">
					...
					<li><a class="active" href="postres.php">Postres</a><span> </span></li>
	...
	<!----end-header---->
	<!--banner-starts-->
	<div class="bannerPostres" id="home">
	</div>	
	<!--banner-ends--> 
	<!--FlexSlider-->
