<?php 
    ...
    if (mysqli_connect_errno()) {
        ...
        $sql = 'SELECT Name, Price, Description, imgName FROM Dishes WHERE Category = 8';
		...
		//Segunda consulta
		$sql2 = 'SELECT Dato FROM didYouKnow WHERE ID = 8';
...
<body>
	...
	<!----end-header---->
	<!--banner-starts-->
	<div class="bannerHuevos" id="home">
	</div>	
	<!--banner-ends--> 
	<!--FlexSlider-->
	...
	<div class="offer">
		<div class="container">
			<div class="offer-top heading">
				<h4>Huevos y especialidades mexicanas</h4>
			</div>
